local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
    ...
    MainSection:NewButton("Aimbot", "Yes.", function()
...
MainSection:NewSlider("Aimbot Smoothness", "Changes How slow you aim (the higher the value the more legit it looks)", 8, 0, function(s) -- 500 (MaxValue) | 0 (MinValue)
end)
...
MainSection:NewButton("Enable ESP", "PRO", function()
...
---Created By 0x83
    ...
    MainSection:NewButton("Tracers", "Kinda like ESP but you got lines on your screen", function()
        local lplr = game.Players.LocalPlayer
local camera = game:GetService("Workspace").CurrentCamera
local CurrentCamera = workspace.CurrentCamera
local worldToViewportPoint = CurrentCamera.worldToViewportPoint
